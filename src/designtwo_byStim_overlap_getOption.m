function opt = designtwo_byStim_overlap_getOption()
    %   __  ____  ____     _      _    _
    %  / _)(  _ \(  _ \   | |    / \  | )
    % ( (_  )___/ )___/   | |_  / _ \ | \
    %  \__)(__)  (__)     |___||_/ \_||__)
...
%     % 18 runs
     opt.subjectsVisual = {['001'],['002'],['003'],['004'],['005'],['007'],['008'],['009'],['010'],['011'],['012'],['013'],['014'],['015'],['016'],['017'],['018'],['019'],['020'],['022'],['023'],['024']}; %['001'],['002'],['003'],['004'],['005'],['007'],['008'],['009'],['010'],['011'],['012'],['013'],['014'],['015'],['016'],['017'],['018'],['019'],['020'],['022'],['023'],['024']
...
%     opt.locDir = '/Users/falagiarda/project-combiemo-playaround/only_localizers_analyses/derivatives-voice/derivatives/cpp_spm/';
     opt.maskDir = '/Users/falagiarda/project-combiemo-playaround/design-two/localizers_individual_area/localizers_overlap/label-intersection/'; 
     opt.maskNames = {'label-intersection_localizersOverlaprPreCG.nii','label-intersection_localizersOverlaplPreCG.nii','label-intersection_localizersOverlaprMTG.nii','label-intersection_localizersOverlaplMTG.nii'};



     % MVPA results directory 
     opt.resDir = '/Users/falagiarda/project-combiemo-playaround/design-two/localizers_individual_area/localizers_overlap/label-intersection/results/'; 
...
%     opt.dataExtensionDir = '/stats/ffx_task-eventrelatedCombiemo.../ffx_space-MNI_FWHM-';
     %opt.funcFWHM = 2;
...
%    opt.model.file = '/Users/falagiarda/GitHub/combiemo_fMRI_analyses/src/model-eventrelatedAud_smdl.json';
    ...
    % group level ROIs
    opt.cosmomvpa.rois = {'rPreCG','lPreCG','rMTG','lMTG'};
    opt.cosmomvpa.rois = {'rPreCG','lPreCG'};

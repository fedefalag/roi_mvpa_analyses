...
function cosmomvpaFuncRoiCrossValidation_auditory(opt, funcFWHM)
...
%                 end
                ...
                roiPattern = fullfile(strcat(pathMask,'label-expandVox',opt.voxNr(iRoi),'_sub',subID,opt.cosmomvpa.rois(iRoi),opt.thre,'FWHM6.nii'));

function opt = eventrelatedVis_neurosynth_getOption()
    %   __  ____  ____     _      _    _
    %  / _)(  _ \(  _ \   | |    / \  | )
    % ( (_  )___/ )___/   | |_  / _ \ | \
    %  \__)(__)  (__)     |___||_/ \_||__)
    ...
    opt.subjects = {['001'],['004'],['005']}; %['002'],['003'],['004'],['005'],['006'],['007'],['008']
...
%     opt.maskDir = strcat('/Users/falagiarda/project-combiemo-playaround/exploring_the_repos/derivatives-visual/derivatives/cpp_spm/neurosynth_masks/label-expand/');
%     
%     opt.resDir = strcat('/Users/falagiarda/project-combiemo-playaround/exploring_the_repos/derivatives-visual/derivatives/cpp_spm/neurosynth_masks/label-expand/results/');
...
% % design two
    ...
    % opt.maskDir = '/stats/ffx_task-facelocalizerCombiemo/ffx_space-MNI_FWHM-2/'; % sphereROIs masks are instead here: '/ROIs/resized/';
    opt.maskDir = '/Users/falagiarda/project-combiemo-playaround/design-two/derivatives/cpp_spm/neurosynth_masks_vis/label-expand/';
    
    opt.resDir = '/Users/falagiarda/project-combiemo-playaround/design-two/derivatives/cpp_spm/neurosynth_masks_vis/label-expand/results/';
    opt.derivExtension = 'derivatives/cpp_spm/';
    opt.dataExtensionDir = '/stats/ffx_task-eventrelatedCombiemoVisual/ffx_space-MNI_FWHM-';
...
%    opt.model.file = '/Users/falagiarda/GitHub/combiemo_fMRI_analyses/src/model-eventrelatedAud_smdl.json';
    ...
    opt.cosmomvpa.ffxResults = {'beta','t_maps'}; % 'beta','t_maps'
    % this is calculated for right and left TVAs
    
    % opt.cosmomvpa.rois = {'rFFA','rOFA','rSTS','lFFA','lOFA','lSTS'};
    
    opt.cosmomvpa.rois = {'rFFA','rOFA','lFFA','lOFA'}; % 'rFFA','rOFA','lFFA','lOFA'
    opt.voxNr = {'510','423','462','394'}; % '510','423','462','394'
    
%     opt.cosmomvpa.rois = {'rSTS'};
%     opt.voxNr = {'301'};

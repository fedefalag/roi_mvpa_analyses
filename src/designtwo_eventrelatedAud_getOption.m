function opt = designtwo_eventrelatedAud_getOption()
    %   __  ____  ____     _      _    _
    %  / _)(  _ \(  _ \   | |    / \  | )
    % ( (_  )___/ )___/   | |_  / _ \ | \
    %  \__)(__)  (__)     |___||_/ \_||__)
    ...
    opt.subjects = {['007'],['008']}; %['001'],['003'],['004'],['005'],['006'],['007'],['008'],['009'],['010'],['011'],['012'],['013'],['014'],['015'],['016'],['017'],['018'],['019'],['020'],['021']
...
%     opt.locDir = '/Users/falagiarda/project-combiemo-playaround/only_localizers_analyses/derivatives-voice/derivatives/cpp_spm/';
     opt.maskDir = '/Users/falagiarda/project-combiemo-playaround/design-two/derivatives/cpp_spm/neurosynth_masks_aud/label-expand/'; % sphereROIs masks are instead here: '/ROIs/resized/';
%     
     % MVPA results directory 
     opt.resDir = '/Users/falagiarda/project-combiemo-playaround/design-two/derivatives/cpp_spm/neurosynth_masks_aud/label-expand/designtwo_results'; % or /cosmoMVPA_res/funcROIs_res/
...
%    opt.model.file = '/Users/falagiarda/GitHub/combiemo_fMRI_analyses/src/model-eventrelatedAud_smdl.json';
    ...
    opt.cosmomvpa.ratioToKeep = [250]; % min tmaps

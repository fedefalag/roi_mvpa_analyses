...
opt.rois.sub010.names = {'rFFA','lFFA','rOFA','lOFA','rpSTS','lpSTS','rMFS','lMFS'}; % lOFA has 103vx - switched to sphere
%opt.rois.sub010.action = {2,2,1,0,1,1,1,2};
opt.rois.sub010.action = {0,0,0,2,0,0,0,0};
...
opt.rois.sub011.action = {0,0,1,1,1,1,1,1};

opt.rois.sub012.coord = {[39 -52 -21],[0,0,0],[23 -94 -5],[-31 -91 -13],[62 -52 5],[-55 -44 13],[0 0 0],[0 0 0]}; % [-31 -91 -13]
opt.rois.sub012.names = {'rFFA','lFFA','rOFA','lOFA','rpSTS','lpSTS','rMFS','lMFS'}; % lOFA has 125vx - switched to sphere
%opt.rois.sub012.action = {2,0,1,0,1,1,0,0};
opt.rois.sub012.action = {0,0,0,2,0,0,0,0};
...
opt.rois.sub014.names = {'rFFA','lFFA','rOFA','lOFA','rpSTS','lpSTS','rMFS','lMFS'}; % rFFA has 132vx ; lOFA has 117vx - switched to sphere
%opt.rois.sub014.action = {0,2,1,0,1,1,1,1};
opt.rois.sub014.action = {0,0,0,2,0,0,0,0};
...
opt.rois.sub016.names = {'rFFA','lFFA','rOFA','lOFA','rpSTS','lpSTS','rMFS','lMFS'}; % lFFA has 136vx ; lOFA has 132vx - switched to sphere ; rMFS has 160vx
%opt.rois.sub016.action = {1,0,2,0,1,1,1,2};
opt.rois.sub016.action = {0,0,0,2,0,0,0,0};
...
opt.rois.sub020.names = {'rFFA','lFFA','rOFA','lOFA','rpSTS','lpSTS','rMFS','lMFS'}; % rFFA has 124vx ; lFFA has 100vx - switched to sphere 
%opt.rois.sub020.action = {0,0,0,0,1,2,2,2};
opt.rois.sub020.action = {0,2,0,0,0,0,0,0};
...
opt.rois.sub022.coord = {[47 -42 -23],[-39 -42 -23],[39 -86 -15],[-42 -83 -15],[52 -44 5],[-49 -44 3],[44 -3 44],[-47 2 47]}; % [47 -42 -23] ; [39 -86 -15]
opt.rois.sub022.names = {'rFFA','lFFA','rOFA','lOFA','rpSTS','lpSTS','rMFS','lMFS'}; % rFFA has 113vx ; rOFA has 115vx
%opt.rois.sub022.action = {0,2,0,2,1,1,1,1};
opt.rois.sub022.action = {2,0,2,0,0,0,0,0};

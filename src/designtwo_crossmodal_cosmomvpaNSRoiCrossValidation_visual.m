...
function designtwo_crossmodal_cosmomvpaNSRoiCrossValidation_visual(opt, funcFWHM)
...
%                 end
                ...
                for iMask = 1:length(roiMasks)
                    ...
                    for iConditionToTest = 1:length(conditionsToTest)
                            ...
                            meanPattern_vis = mean(ds_vis.samples,2);  % get the mean for every pattern
                            ...
                            meanPattern_aud = mean(ds_aud.samples,2);  % get the mean for every pattern

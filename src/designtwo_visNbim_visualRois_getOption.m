function opt = designtwo_visNbim_visualRois_getOption()
    %   __  ____  ____     _      _    _
    %  / _)(  _ \(  _ \   | |    / \  | )
    % ( (_  )___/ )___/   | |_  / _ \ | \
    %  \__)(__)  (__)     |___||_/ \_||__)
...
opt.moreMaskPath = '/task-facelocalizerCombiemo_001unc/all_masks_for_mvpa/';
...
opt.resDir = '/Users/falagiarda/project-combiemo-playaround/design-two/localizers_individual_area/MVPA_best-mod_vs_multim/vis-rois';
...
opt.rois = {'lFFA','rFFA','lOFA','rOFA','lpSTS','rpSTS','lMFS','rMFS'};
%opt.rois = {'rTVA','lTVA'};

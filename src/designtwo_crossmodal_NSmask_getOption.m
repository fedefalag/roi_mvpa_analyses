function opt = designtwo_crossmodal_NSmask_getOption()
    %   __  ____  ____     _      _    _
    %  / _)(  _ \(  _ \   | |    / \  | )
    % ( (_  )___/ )___/   | |_  / _ \ | \
    %  \__)(__)  (__)     |___||_/ \_||__)
    ...
    opt.taskName = 'eventrelatedCombiemoV';
    ...
    % 18 runs
    opt.subjectsVisual = {['001'],['003'],['004'],['005'],['007'],['008'],['009'],['010'],['012'],['013'],['014'],['015'],['016'],['017'],['018'],['019'],['020'],['023'],['024']}; %['001'],['003'],['004'],['005'],['006'],['007'],['008'],['009'],['010'],['011'],['012'],['013'],['014'],['015'],['016'],['017'],['018'],['019'],['020'],['021']
    opt.subjectsAuditory = {['001'],['003'],['004'],['005'],['006'],['007'],['008'],['009'],['010'],['011'],['012'],['013'],['015'],['016'],['017'],['018'],['019'],['020'],['023'],['024']}; %['001'],['003'],['004'],['005'],['006'],['007'],['008'],['009'],['010'],['011'],['012'],['013'],['014'],['015'],['016'],['017'],['018'],['019'],['020'],['021']
...
%     opt.subjectsAuditory = {['011']};
    ...
    % for crossmodal
    opt.subjects = {['001'],['003'],['004'],['005'],['007'],['008'],['009'],['010'],['012'],['013'],['015'],['016'],['017'],['018'],['019'],['020'],['023'],['024']};
...
% masks
opt.maskNames = {'rspace-MNI_label-neurosynthFacialexpressionrSTSassociationtestbinaryExpandVox257_mask'};

     % MVPA results directory 
     opt.resDir = '/Users/falagiarda/project-combiemo-playaround/design-two/derivatives/cpp_spm/neurosynth_masks/neurosynth_binary/label-expand/across_mod_mvpa_res/'; 
...
%     opt.cosmomvpa.rois = {'rFFA','lFFA','rOFA','lOFA','rpSTS'};
    % for crossmodal decoding (areas that succeded in within modality MVPA for both visual and auditory data%
    opt.cosmomvpa.rois = {'rpSTS'};

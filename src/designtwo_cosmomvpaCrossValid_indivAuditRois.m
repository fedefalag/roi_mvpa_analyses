...
function designtwo_cosmomvpaCrossValid_indivAuditRois(opt, funcFWHM)
...
%                 end
        ...
        pathOutput = strcat(opt.resDir,'sub-',opt.subjects{iSub},'/task-voicelocalizerCombiemo/all_masks_for_mvpa/',opt.modResDir{iTask});

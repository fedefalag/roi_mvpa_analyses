...
function designtwo_cosmomvpaFuncRoiCrossValidation_auditory(opt, funcFWHM)
...
%                 end
                ...
                roiPattern = fullfile(strcat(pathMask,opt.maskNames{iRoi},'.nii'));

function opt = designtwo_eventrelatedVis_groupmask_getOption()
    %   __  ____  ____     _      _    _
    %  / _)(  _ \(  _ \   | |    / \  | )
    % ( (_  )___/ )___/   | |_  / _ \ | \
    %  \__)(__)  (__)     |___||_/ \_||__)
...
opt.taskName = 'eventrelatedCombiemoVisual';
    ...
    % 18 runs
    opt.subjectsVisual = {['024']}; %['001'],['003'],['004'],['005'],['006'],['007'],['008'],['009'],['010'],['011'],['012'],['013'],['014'],['015'],['016'],['017'],['018'],['019'],['020'],['021']
    opt.subjectsAuditory = {['020']};
    opt.subjectsBimodal = {['024']};
%     % 19 runs
...
%     opt.locDir = '/Users/falagiarda/project-combiemo-playaround/only_localizers_analyses/derivatives-voice/derivatives/cpp_spm/';
     opt.maskDir = '/Users/falagiarda/project-combiemo-playaround/design-two/derivatives/cpp_spm/rfx_task-facelocalizerCombiemo/ffx_FWHM-6/rfx_space-MNI_FWHM-8/masks/'; 
     ...
     opt.resDir = '/Users/falagiarda/project-combiemo-playaround/design-two/derivatives/cpp_spm/rfx_task-facelocalizerCombiemo/ffx_FWHM-6/rfx_space-MNI_FWHM-8/masks/within_mod_mvpa_results/'; 
...
%    opt.model.file = '/Users/falagiarda/GitHub/combiemo_fMRI_analyses/src/model-eventrelatedAud_smdl.json';
    ...
    opt.cosmomvpa.ratioToKeep = [40]; % n of voxels for feature selection

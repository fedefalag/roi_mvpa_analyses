function opt = designtwo_eventrelatedVis_getOption()
    %   __  ____  ____     _      _    _
    %  / _)(  _ \(  _ \   | |    / \  | )
    % ( (_  )___/ )___/   | |_  / _ \ | \
    %  \__)(__)  (__)     |___||_/ \_||__)
    ...
    opt.subjects = {['007'],['008'],['009'],['010'],['011'],['012'],['013'],['014'],['015'],['016'],['017'],['018'],['019'],['020']}; %['001'],['003'],['004'],['005'],['006'],['007'],['008'],['009'],['010'],['011'],['012'],['013'],['014'],['015'],['016'],['017'],['018'],['019'],['020'],['021']
...
%     opt.locDir = '/Users/falagiarda/project-combiemo-playaround/only_localizers_analyses/derivatives-voice/derivatives/cpp_spm/';
     opt.maskDir = '/Users/falagiarda/project-combiemo-playaround/design-two/derivatives/cpp_spm/neurosynth_masks_vis/label-expand/'; % sphereROIs masks are instead here: '/ROIs/resized/';
%     
     % MVPA results directory 
     opt.resDir = '/Users/falagiarda/project-combiemo-playaround/design-two/derivatives/cpp_spm/neurosynth_masks_vis/label-expand/designtwo_results'; % or /cosmoMVPA_res/funcROIs_res/
...
%     % neurosynth left and right FFAs
%     opt.cosmomvpa.rois = {'rFFA','lFFA'};
%     opt.voxNr = {'510','462'};
%     % neurosynth left and right OFAs
%     opt.cosmomvpa.rois = {'rOFA','lOFA'};
%     opt.voxNr = {'423','394'};
    % neurosynth right STS

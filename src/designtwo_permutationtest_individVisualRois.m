...
% first run % first run opt = designtwo_permutationtest_visualRois_getOption();

function designtwo_permutationtest_individVisualRois(opt, funcFWHM)
...
%                 end
        ...
        pathOutput = strcat('/Users/falagiarda/project-combiemo-playaround/design-two/localizers_individual_area/MVPA_permutations/vis-rois/',opt.modResDir{iTask});

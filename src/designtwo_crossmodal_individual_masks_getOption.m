function opt = designtwo_crossmodal_individual_masks_getOption()
    %   __  ____  ____     _      _    _
    %  / _)(  _ \(  _ \   | |    / \  | )
    % ( (_  )___/ )___/   | |_  / _ \ | \
    %  \__)(__)  (__)     |___||_/ \_||__)
    ...
    % sub 006 (106) does not have aud-defined MFS %
    % opt.subjects = {['106'],['111'],['114']};
    
    % for visual areas
    opt.subjects = {['001'],['002'],['003'],['004'],['005'],['007'],['008'],['009'],['010'],['012'],['013'],['015'],['016'],['017'],['018'],['019'],['020'],['021'],['022'],['023'],['024'],['106'],['111'],['114']};
    opt.subjects = {['021']};
    % for auditory areas - because some subj don't have any MFS, namely 4, 6, 21 and 24 %
    %opt.subjects = {['001'],['002'],['003'],['005'],['007'],['008'],['009'],['010'],['012'],['013'],['015'],['016'],['017'],['018'],['019'],['020'],['022'],['023']};
    
    %opt.subjects = {['111'],['114']};
     % 19 runs for both visual and auditory
     % not to be run for aud-defined MFS cos sub-021 does not have MFS %
     %opt.subjects = {['021']};
...
%     opt.locDir = '/Users/falagiarda/project-combiemo-playaround/only_localizers_analyses/derivatives-voice/derivatives/cpp_spm/';
    ...
    % visual masks
    opt.moreMasksPath = '/task-facelocalizerCombiemo_001unc/all_masks_for_mvpa/';
    %auditory masks
    opt.moreMasksPath = '/task-voicelocalizerCombiemo/all_masks_for_mvpa/';

% MVPA results directory
opt.resDir = '/Users/falagiarda/project-combiemo-playaround/design-two/localizers_individual_area/crossmodal-decoding_res';

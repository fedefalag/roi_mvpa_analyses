...
% first run % first run opt = designtwo_permutationtest_auditRois_getOption();

function designtwo_permutationtest_individAuditRois(opt, funcFWHM)
...
for iTask = 1:2%1:length(opt.tasks)
...
%                 end
        ...
        pathOutput = strcat('/Users/falagiarda/project-combiemo-playaround/design-two/localizers_individual_area/MVPA_permutations/aud-rois/',opt.modResDir{iTask});
